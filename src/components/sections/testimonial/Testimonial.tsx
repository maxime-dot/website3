      ...
      <div className="container testimonial-content d-flex flex-row">
        <div className="testimonial-info d-flex flex-col">
          <div className="text-group d-flex flex-col">
            ...
            >
              <span> They are more than just customers</span> <br />
              They have been with us since the beginning of their digital
              adventure, AKATA GOAVANA has been part of their success story for
              years now.
            </motion.p>
          </div>
