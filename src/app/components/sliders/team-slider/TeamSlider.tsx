            ...
            <div className="main-content">
                <div className="slider-container container d-flex-space-between">
                    ...
                    <div className="profile-words d-flex flex-col">
                        <strong className={"profile-post akata-title-medium"}>CEO</strong>
                        <small className={"profile-post-acronym akata-text-medium"}>Chef Executive Officer</small>
                        <p className={"akata-text-medium words"}>I will take the Reunionese singer Blacko&apos;s
                        ...
                        <p className={"akata-text-medium words"}>
                        ...
                        <div className="social-link-group d-flex flex-row">
